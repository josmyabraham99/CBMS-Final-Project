...
{
    public partial class CreateDasee : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CabNumber = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDrivers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DropDown = table.Column<int>(type: "int", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vehicle = table.Column<int>(type: "int", nullable: false),
                    Liscense = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Contact = table.Column<long>(type: "bigint", maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
